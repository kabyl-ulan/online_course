...
import com.kg.platform.online_course.services.OrderService;
...
public class OrderController {
    ...
    public Page<OrderResponse> getAllOrders(@PageableDefault(sort = "id", direction = Sort.Direction.DESC) Pageable pageable) {
