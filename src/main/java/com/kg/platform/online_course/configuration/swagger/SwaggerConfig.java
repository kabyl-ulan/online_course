package com.kg.platform.online_course.configuration.swagger;
...
public class SwaggerConfig {
    ...
    public OpenAPI customerOpenAPI() {
        return new OpenAPI().components(new Components().addSecuritySchemes(API_KEY, apiKeySecuritySchema())).info(new Info().title("Online-course"))
